      ...
      <div className="shadow-Card container mx-auto rounded-[20px]">
        <div className="lg:py-[70px]">
          <div className="lg:leading-[60px]">
            <h1 className="text-[20px] lg:text-[45px] text-white text-center font-bold">
          ...
          <p className="text-[#ececec] lg:w-[600px] mx-auto text-center mt-4">
          ...
          <div className="text-center mt-4">
            <button className="border-[#ececec] px-2 py-1 lg:px-4 lg:py-2 text-[#ececec] border-[1px] rounded-full">
              Download the app
            </button>
          </div>
        </div>
